...
int	ScavTrap::hp(void) const { return (_hp); }
int	ScavTrap::hpmax(void) const { return (_hpmax); }
int	ScavTrap::mp(void) const { return (_mp); }
int	ScavTrap::mpmax(void) const { return (_mpmax); }
int	ScavTrap::level(void) const { return (_level); }
std::string		ScavTrap::name(void) const { return (_name); }
int	ScavTrap::melee(void) const { return (_melee); }
int	ScavTrap::ranged(void) const { return (_ranged); }
int	ScavTrap::armor(void) const { return (_armor); }
int	ScavTrap::matk(void) const { return (_matk); }
